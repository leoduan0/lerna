    ...
    <div className="space-y-2">
      <ol className="w-full">
        {props.choices.map((choice, index) => (
          <li key={index}>
            <button
              className={`${selected == index ? 'bg-blue-500 dark:bg-blue-600' : 'hover:bg-neutral-300 dark:hover:bg-neutral-500'} w-full cursor-pointer rounded-lg border-2 border-black p-2 text-left transition active:scale-[0.99] dark:border-white`}
